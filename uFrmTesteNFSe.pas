...
begin
  ...
  try
    ...
    // Aqui retornamos o buffer e você pode inspecionar Ret no log se quiser.
...
begin
  ...
  // Estrutura que você quer (subdiretório do EXE)
  ...
  // 1) Log da LIB (sessão Principal)
  ACBrSetConfigValue('Principal', 'LogPath', AnsiString(PathLogLib));

  // 2) NFSe: paths corretos (sessão NFSe)
